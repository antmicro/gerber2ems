...
Ports of interest should be marked using a special simulation port footprint.
Rotation and position should be accurate. (It's reference number tells the simulator which port to assign to it).
